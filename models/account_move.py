...
class AccountMove(models.Model):
    ...
    x_studio_order_payment_method = fields.Selection([('Cash', 'Cash'), ('Credit', 'Credit')], string='Order Payment Method', readonly=True)
    ...
    x_studio_purchase_type = fields.Selection([('Local', 'Local'), ('Import', 'Import')], string='PR Type', readonly=True)
