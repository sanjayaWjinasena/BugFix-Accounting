...
class AccountMoveLine(models.Model):
    ...
    x_studio_related_field_HFHrh = fields.Char(string='New Related Field', related='move_id.tax_totals', store=False, readonly=True)
    x_studio_related_field_HO3gE = fields.Char(string='New Related Field', readonly=True, store=False)
    x_studio_related_field_MnJZJ = fields.Char(string='New Related Field', related='move_id.tax_totals', store=False, readonly=True)
    ...
    x_studio_tax = fields.Float(string='Tax')  # was Monetary (no currency_field, related='move_id.amount_tax', store=True, readonly=True)
    ...
    x_studio_total_earnings = fields.Float(string='Total Earnings')  # was Monetary (no currency_field, related='x_studio_contract_id.wage', store=True, readonly=True)
