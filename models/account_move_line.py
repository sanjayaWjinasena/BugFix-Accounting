...
class AccountMoveLine(models.Model):
    ...
    x_studio_customer_group_type = fields.Selection([('General', 'General'), ('Distributor', 'Distributor'), ('Dealer', 'Dealer')], string='Customer Group Type', readonly=True)
    ...
    x_studio_journal_type = fields.Selection([('Bill', 'Bill'), ('Payment', 'Payment'), ('Settlement', 'Settlement')], string='Journal Type', readonly=True)
    ...
    x_studio_payment_status = fields.Selection([('not_paid', 'Not Paid'), ('in_payment', 'In Payment'), ('paid', 'Paid'), ('partial', 'Partially Paid'), ('reversed', 'Reversed'), ('invoicing_legacy', 'Invoicing App Legacy')], string='Payment Status', readonly=True)
    x_studio_pr_type = fields.Selection([('Local', 'Local'), ('Import', 'Import')], string='PR Type', readonly=True)
    ...
    x_studio_status = fields.Selection([('draft', 'Draft'), ('posted', 'Posted'), ('cancel', 'Cancelled')], string='Status', readonly=True)
    x_studio_status_1 = fields.Selection([('draft', 'Draft'), ('posted', 'Posted'), ('cancel', 'Cancelled')], string='Status', readonly=True)
